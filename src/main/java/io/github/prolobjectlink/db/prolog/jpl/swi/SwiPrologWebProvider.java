 ...
 * #L%
 */
package io.github.prolobjectlink.db.prolog.jpl.swi;
...
public class SwiPrologWebProvider extends SwiProlog implements PrologWebProvider {

	public PrologWebEngine newEngine() {
		return new SwiPrologWebEngine(this);
	}
